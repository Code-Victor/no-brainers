...
export function Evolution() {
  ...
  return (
    <section className="font-geist py-8 md:py-16 px-4 max-w-full bg-gray-50">
        ...
        <div className="text-left space-y-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-center py-6">
              <div className="bg-gray-200 rounded-full p-1.5 flex">
                {tabs.map((tab) => {
                    ...
                    >
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute inset-0 bg-gray-50 rounded-full shadow-sm"
                          transition={{
                            type: "spring",
                            bounce: 0.2,
                            duration: 0.6,
